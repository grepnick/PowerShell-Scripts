...
while ($true) {
    ...
    Write-Host "Signal Strength: $signalStrength | TX Rate: $transmitRate Mbps | RX Rate: $receiveRate Mbps | Band: $wirelessBand | Channel: $wirelessChannel | AP: $wirelessBSSID"
